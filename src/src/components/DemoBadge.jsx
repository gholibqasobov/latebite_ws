        ...
        <div className="card p-4 max-w-xs animate-fade-up">
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm">
              <p className="font-semibold text-primary">Демо-версия</p>
              <p className="text-primary-dark/70 mt-1">
                Прототип для презентации. Оплата Kaspi, вход и уведомления —
                имитация. Данные кафе и блюд демонстрационные.
              </p>
            </div>
